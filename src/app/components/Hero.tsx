...
const Hero = () => {
  return (
    <section className="text-gray-600 body-font bg-gradient-to-br from-blue-200 to bg-pink-100 py-20 h-screen">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="ml-36 md:w-1/2 flex flex-col md:items-end md:text-right mb-16 md:mb-0 items-end text-end">
      ...
      <div className="flex-col justify-center">
        <Link href="\project">
        <button className="mx-6 inline-flex text-white font-semibold text-xl bg-gradient-to-b from-blue-300 to-pink-400 border-0 py-2 px-8 focus:outline-none rounded-lg

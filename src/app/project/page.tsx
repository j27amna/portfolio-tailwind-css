...
const Projects = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div>
        ...
        <div className="flex flex-row -m-4">
         <div className="xl:w-1/2 md:w-1/1 p-4 justify-center items-center">
          <div className="border border-purple-300 shadow-sm p-6 rounded-lg text-center hover-affect">
          <Link href="https://ecommerce-custom-css.vercel.app/" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Ecommerce Website With Custom CSS</h2>
          <Image src="/woodico-css.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='mx-auto items-center my-4 relative w-auto h-40' />
        ...
        <div className="xl:w-1/2 md:w-1/1 p-4">
          <div className="border border-purple-300 shadow-sm p-6 rounded-lg text-center  hover-affect">
          <Link href="https://ecommerce-tailwind-hwvn8nc7x-amna-jehanzebs-projects.vercel.app/?vercelToolbarCode=4s-5F6QSUkO92gM" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Ecommerce Website With Tailwind CSS</h2>
          <Image src="/woodico-css.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='w-auto h-40 relative mx-auto items-center my-4' />
      ...
      <div className="xl:w-1/2 md:w-1/1 p-4 justify-center items-center">
          <div className="border border-purple-300 shadow-sm p-6 rounded-lg text-center hover-affect">
          <Link href="https://marketplace-builder-hackathon-lovat.vercel.app/" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Marketplace Builder - Advanced E-Commerce Platform </h2>
          <Image src="/bandage.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='mx-auto items-center my-4 relative w-auto h-40' />
          <p className="leading-relaxed text-base">This <b>e-commerce website</b> is designed to empower businesses to create their own online marketplaces. Packed with advanced tools and features with responsive design.</p>
          </Link>
        </div>
        </div>
      </div>
    ...
    <div className="flex flex-row -m-4">
    <div className="xl:w-1/2 md:w-1/1 p-4 justify-center items-center">
        <div className="border border-purple-300 shadow-sm p-9 rounded-lg text-center hover-affect">
          <Link href="https://registration-form-css.vercel.app/" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Registration Form</h2>
          <Image src="/form.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='mx-auto items-center my-4 relative w-auto h-40' />
     ...
     <div className="xl:w-1/2 md:w-1/1 p-4 justify-center items-center">
        <div className="border border-purple-300 shadow-sm p-6 rounded-lg text-center hover-affect">
        <Link href="https://resume-builder-flame-one.vercel.app/" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Resume Builder</h2>
          <Image src="/resume.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='mx-auto items-center my-4 relative w-auto h-40' />
    ...
    <div className="xl:w-1/2 md:w-1/1 p-4 justify-center items-center">
        <div className="border border-purple-300 shadow-sm p-6 rounded-lg text-center hover-affect">
          <Link href="https://the-whisk-flame.vercel.app/" target='_blank' rel='noopener noreferrer'>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Restaurant Landing Page</h2>
          <Image src="/restaurant.jpg" width="400" height="400" alt="woodico (Nextjs Project)" className='mx-auto items-center my-4 relative w-auto h-40' />
          <p className="leading-relaxed text-base">This project showcases a <b>modern </b>and <b>visually appealing user interface,</b> crafted entirely with HTML and CSS. It focuses on clean and accessible design principles to ensure an exceptional user experience across all devices.</p>
          </Link>
        </div>
     </div>
    </div>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Adventure-Game" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Student-Management-System-" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Word-Counter" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Countdown-Timer" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Calculators-j27amna" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/Currency-Convertor" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/OOP" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/TypeScript-Quiz" target='_blank' rel='noopener noreferrer'>
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-purple-300 shadow-md p-6 rounded-lg hover-affect">
          <Link href="https://github.com/j27amna/ATM" target='_blank' rel='noopener noreferrer'>
    ...
    <Link href="https://github.com/j27amna" target='_blank' rel='noopener noreferrer'><button className="my-8 inline-flex text-white font-bold text-xl bg-gradient-to-b from-blue-300 to-pink-400 border-0 py-2 px-8 focus:outline-none rounded-lg
